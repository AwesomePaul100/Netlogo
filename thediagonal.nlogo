globals [
  ...
  green-turned-yellow-count ; New global variable to track green cells turned yellow.
...
to create-grid
  ...
  repeat grid-size [
      ...
      set pcolor orange
      set green-turned-yellow-count green-turned-yellow-count + 1 ; Increment count
      ]
      set x x + cell-size
